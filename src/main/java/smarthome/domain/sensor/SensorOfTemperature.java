...
public class SensorOfTemperature implements Sensor {
    ...
    /**
     * Constructs a new SensorOfTemperature object with the given device id and sensor model name
    ...
    /**
     * Constructs a new SensorOfTemperature object with the given sensor id, device id and sensor model name
     *
     * @param sensorId        the sensor id
     * @param deviceId        the device id where this sensor is located
     * @param sensorModelName the sensor model name
     */
    protected SensorOfTemperature(SensorId sensorId, DeviceId deviceId, SensorModelName sensorModelName) {
    ...
    public Value getValue() {
        return new TemperatureValue(25.0); //Default value
    }
    ...
    public boolean equals(Object object) {
        ...
        final SensorOfTemperature that = (SensorOfTemperature) object;
